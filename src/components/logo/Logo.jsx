...
const Logo = forwardRef(({ disabledLink = false, sx, ...other }, ref) => {
  ...
  const logo = (
    <Box
      ...
      {...other}
    >
      <svg width="100%" height="100%" viewBox="0 0 220 200" xmlns="http://www.w3.org/2000/svg">
        <circle fill={PRIMARY_MAIN} cx="55" cy="50" r="50"/>
        <circle fill={PRIMARY_MAIN} cx="170" cy="50" r="50"/>
        <circle fill={PRIMARY_MAIN} cx="112.5" cy="150" r="50"/>
      </svg>
      {/*<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
        ...
        <g transform="translate(0.000000,213.000000) scale(0.100000,-0.100000)" fill={(theme.palette.mode == 'light')?theme.palette.common.black:theme.palette.common.white} stroke="none">
