...
import { DatabaseTableRow, DatabaseTableToolbar } from '../../../sections/dashboard/database/list';
...
export default function RaoSimiListPage({onlyWon = false}) {
  ...
  useEffect(() => {
    if(onlyWon) {
      const _resData = databasesInitialWon.map(
