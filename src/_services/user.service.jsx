 ...
 * @returns {Promise}
 */
let setUserPrefs = (user) => {
    return Axios.put('api/usersprefs/'+user.id, {prefs: user.prefs});
}

// Décaraltion des esrvices pour import
export const userService = {
    getAllUsers, getAllUsersByCat, getAllUsersByNotCat, getUser, addUser, updateUser, updateUserPassword, deleteUser, getUsersKPI, setUserPrefs
}